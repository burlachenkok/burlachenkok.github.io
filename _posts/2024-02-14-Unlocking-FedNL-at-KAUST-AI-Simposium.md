...
**B)** We do not depend on any hunger in memory footprint 3rd party computation and data processing software frameworks libraries. We tested our implementation on [x86-64, AArch64] x [macOS, Linux, Windows] however in principle it can be run on any [POSIX](https://en.wikipedia.org/wiki/POSIX) and [WinAPI](https://en.wikipedia.org/wiki/Windows_API) Operating System interfaces with available [ISO/IEC 14882 C++2020](https://www.iso.org/standard/79358.html) build system.
