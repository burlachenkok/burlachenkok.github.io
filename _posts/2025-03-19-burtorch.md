...
with well-known industry best-practice solutions for automatic differentiation in the context of Machine Learning, considering their different operation modes, operating systems, and programming language APIs.
...
-- [(i) online](https://www.podbean.com/eas/pb-zs34b-16d2942) 
-- [(ii) offline](https://burlachenkok.github.io/podcasts/butrch-generated-interview.mp3).
