...
With the same security level our work practically outperforms CKKS in terms of communicated information from client to master and from master to client by factor 300x.
