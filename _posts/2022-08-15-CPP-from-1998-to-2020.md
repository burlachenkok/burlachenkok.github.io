...
This Technical Note is devoted to covering information regarding the C and all primary C++ programming language standards: C++03/98/11/14/17/20.

---

I am glad to share a Technical Note with subtle details regarding the C and all primary C++ programming language standards based on my experience and materials from the [Reference Section](https://github.com/burlachenkok/CPP_from_1998_to_2020/blob/main/Cpp-Technical-Note.md#references) of that document.
...
The information in that technical note can be helpful mainly for three categories of people:
