...
<center>
<img height="256px" src="https://burlachenkok.github.io/images/burtorch-logo-2.png"/>
</center>
...
The paper compares [BurTorch (Burlachenko and Richtárik, 2025)](https://arxiv.org/abs/2405.14852) with well-known industry best-practice solutions used across different operation modes and programming language APIs. The list of frameworks includes the following:
...
The benchmarks included experiments on computation graphs of varying scales, from a few intermediate operations to comparisons with a miniaturized GPT-3-like model [(Brown et al., 2020)](https://arxiv.org/abs/2005.14165).
...
BurTorch, like any high-performance framework with low-latency capabilities, holds the potential for misuse in non-beneficial ways, as with any advanced technology. The authors acknowledge their responsibility to remain mindful of this before proceeding with any form of source code distribution.

<center>
<table style="text-align:center;">
<tr>
<td style="padding:30px;text-align:center;vertical-align:middle;"> <img height="128px" src="https://burlachenkok.github.io/materials/KAUST-logo.svg"/> </td>
</tr>
</table>
</center>
